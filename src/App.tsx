...
import HistoricoPaciente from './screens/medic/HistoricoPaciente';
...
export default function App() {
  ...
  return (  
    <NavigationContainer>
      <Stack.Navigator id="mainStack" initialRouteName="Inicio" screenOptions={{ headerShown: false, animation: 'none' }}>
